...
class VideoAudioExtractor(AudioInputProtocol):
    ...
    async def cleanup(self) -> None:
        ...
        if self._cap:
            self._cap.release()
            self._cap = None
        self._audio_buffer.clear()</content>
<parameter name="filePath">/mnt/c/Users/desar/Documents/Science/UCogNet/src/ucognet/modules/audio/video_audio_extractor.py